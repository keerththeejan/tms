...
<div class="tv-shell p-2 p-lg-3">
  <div class="container-fluid px-0 px-lg-2">
    ...
    <div class="row g-3 mb-3">
      ...
      <div class="col-12 col-md-6 col-xl-3"><div class="tv-card h-100"><div class="tv-label">Amount</div><div class="tv-kpi"><strong class="text-primary">Rs. <?php echo number_format((float) ($tvSummary['total_amount'] ?? 0), 2); ?></strong><span class="tv-muted">Movement total</span></div></div></div>
    </div>
