...
<div class="rep-page container-fluid px-0" id="reportsApp" data-api-base="<?php echo htmlspecialchars($apiBase); ?>">
  ...
  <footer class="rpt-page-footer cn-page-footer rep-print-footer d-none" aria-hidden="true">
    <div class="rpt-thanks cn-thanks">Thank you for choosing <?php echo htmlspecialchars(Helpers::company()['name'] ?? 'Transport Management System'); ?></div>
    <div class="rpt-footer-meta rep-print-meta">
