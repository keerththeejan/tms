...
CREATE TABLE `cashbook_accounts` (
  ...
  `type` enum('cash','bank','branch') COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'cash',
...
INSERT INTO `cashbook_accounts` VALUES (1,'Cash Book',NULL,'cash',0.00,1,'2026-03-22 12:20:41'),(2,'T.S',NULL,'cash',0.00,2,'2026-03-22 12:20:41');
...
-- Dump completed on 2026-03-22 12:27:50
